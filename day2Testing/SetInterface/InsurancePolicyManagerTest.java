...
public class InsurancePolicyManagerTest {
    ...
    public void setUp() throws Exception {
        ...
        policy1 = new Policy("P1001", "Alice", expiry1, "Health", 500);
        policy2 = new Policy("P1002", "Bob", expiry2, "Auto", 300);
        policy3 = new Policy("P1003", "Charlie", expiry3, "Home", 400);
    ...
    public void testDisplayDuplicatePolicies() {
        manager.addPolicy(new Policy("P1001", "Alice", policy1.getExpiryDate(), "Health", 500));  // Adding a duplicate
